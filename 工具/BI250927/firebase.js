    ...
    function deleteField(fieldName) {
        ...
        Promise.all([
            ...
            Object.keys(fuzerenData).forEach(operatorId => {
                if (fuzerenData[operatorId].jieguo && fuzerenData[operatorId].jieguo[fieldName] !== undefined) {
            ...
            Object.keys(jingxiangData).forEach(operatorId => {
                if (jingxiangData[operatorId].jieguo && jingxiangData[operatorId].jieguo[fieldName] !== undefined) {
